...
# @Time    : 03/23/2024
# @Author  : Peng Sun
# @FileName: mask_rotate_faster_rcnn.py
# @Software: PyCharm
...
class MaskRotatedFasterRCNN(RotatedTwoStageDetector):
    """
    Implementation of Rotated `FMask aster R-CNN.`
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(MaskRotatedFasterRCNN, self).__init__(
            backbone=backbone,
            neck=neck,
            rpn_head=rpn_head,
            roi_head=roi_head,
