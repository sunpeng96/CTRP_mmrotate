...
# @Time    : 03/22/2024
# @Author  : Peng Sun
# @FileName: srt_mask_rotate_faster_rcnn.py
# @Software: PyCharm
...
class SrtMaskRotatedFasterRCNN(RotatedTwoStageDetector):
    """
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(SrtMaskRotatedFasterRCNN, self).__init__(
            backbone=backbone,
            neck=neck,
            rpn_head=rpn_head,
            roi_head=roi_head,
    ...
    def forward_train(self,
        ...
        if self.use_mask_img and self.roi_head_type == 'SrtMaskRotatedStandardRoIHead':
