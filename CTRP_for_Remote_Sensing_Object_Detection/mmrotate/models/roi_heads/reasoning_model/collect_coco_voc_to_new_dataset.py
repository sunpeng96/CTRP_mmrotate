...
#compute attribute reasoning_model
NUM_ATTR_REL = 200
...
if __name__ == '__main__':
    # We collect coco/voc gt reasoning_model by matching classes names with VG.
