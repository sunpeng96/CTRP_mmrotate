...
# @Time    : 11/02/2023
# @Author  : Peng Sun
# @FileName: srt_mask_oriented_standard_roi_head.py
# @Software: PyCharm
...
class SrtMaskOrientedStandardRoIHead(OrientedStandardRoIHead):
    """
    ...
    def __init__(self,
        ...
        super(SrtMaskOrientedStandardRoIHead, self).__init__(bbox_roi_extractor,
