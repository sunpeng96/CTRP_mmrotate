...
def draw_rbboxes(ax, bboxes, color='g', with_face=False,  alpha=0.8, thickness=2):
...
def imshow_det_rbboxes(img,
    ...
    if bboxes is not None:
        ...
        draw_rbboxes(ax, bboxes, colors, alpha=1.0, thickness=thickness)
...
def imshow_reason_rbboxes(img,
    ...
    if mask_bboxes is not None:
        ...
        draw_rbboxes(ax, mask_bboxes, colors, with_face=False, alpha=1.0, thickness=thickness)
