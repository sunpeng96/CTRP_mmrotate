...
class MaskDOTADataset(DOTADataset):
    ...
    PALETTE = [(244, 67, 54), (233, 30, 99),  (156, 39, 176), (103, 58, 183),
               ...
               (255, 152, 0), (255, 87, 34),  (180, 0, 0),    (86, 244, 28)]
    ...
    def __init__(self,
        ...
        super(MaskDOTADataset, self).__init__(ann_file, pipeline, **kwargs)
