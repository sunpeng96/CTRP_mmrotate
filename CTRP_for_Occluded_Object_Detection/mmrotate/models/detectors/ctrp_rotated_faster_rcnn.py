...
class CTRPRotatedFasterRCNN(RotatedTwoStageDetector):

    """
        Implementation of Reasoning Faster R-CNN for Object Detection
    """
    ...
    def __init__(self,
        ...
        super(CTRPRotatedFasterRCNN, self).__init__(
            backbone=backbone,
            neck=neck,
            rpn_head=rpn_head,
            train_cfg=train_cfg,
