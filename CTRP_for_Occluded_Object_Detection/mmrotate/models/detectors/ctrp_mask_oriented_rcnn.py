...
from .ctrp_mask_utils import mask_detector, cloud_detector
from .img_random_mask import random_mask

@ROTATED_DETECTORS.register_module()
class CTRPMaskOrientedRCNN(RotatedTwoStageDetector):
    """
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(CTRPMaskOrientedRCNN, self).__init__(
            backbone=backbone,
            neck=neck,
            rpn_head=rpn_head,
            roi_head=roi_head,
    ...
    def forward_train(self,
        ...
        if self.use_mask_img and self.roi_head_type == 'CRTrMaskOrientedStandardRoIHead':
