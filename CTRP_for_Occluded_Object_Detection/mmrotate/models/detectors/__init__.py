...
from .mask_rotate_faster_rcnn import MaskRotatedFasterRCNN


from .ctrp_mask_rotate_faster_rcnn import CTRPMaskRotatedFasterRCNN
from .ctrp_mask_oriented_rcnn import CTRPMaskOrientedRCNN

from .ctrp_rotated_faster_rcnn import CTRPRotatedFasterRCNN
from .ctrp_oriented_rcnn import CTRPOrientedRCNN

from .ctrp_rotated_retinanet import CTRPRotatedRetinaNet
...
__all__ = [
    ...
    'MaskRotatedFasterRCNN',

    'CTRPMaskRotatedFasterRCNN', 'CTRPMaskOrientedRCNN',

    'CTRPRotatedFasterRCNN', 'CTRPOrientedRCNN', 'CTRPRotatedRetinaNet'
]
