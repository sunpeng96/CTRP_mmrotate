...
# @Time    : 03/22/2024
# @Author  : Peng Sun
# @FileName: crtr_mask_rotate_standard_roi_head.py
# @Software: PyCharm
...
class CRTrMaskRotatedStandardRoIHead(RotatedStandardRoIHead):
    """
    ...
    def __init__(self,
        ...
        super(CRTrMaskRotatedStandardRoIHead, self).__init__(bbox_roi_extractor,
