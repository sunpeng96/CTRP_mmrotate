...
class RRandomSampler(BaseSampler):
    ...
    def _sample_neg(self, assign_result, num_expected, **kwargs):
        ...
        # gt_inds_size = torch.nonzero(assign_result.gt_inds == 0, as_tuple=False).size()[0]
        # print(11111, gt_inds_size)
        # if torch.nonzero(assign_result.gt_inds == 0, as_tuple=False).size()[0] == 0:
        #     print(22222, assign_result.gt_inds)
