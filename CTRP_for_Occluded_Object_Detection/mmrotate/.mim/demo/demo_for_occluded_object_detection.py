_base_ = [
    '../configs/_base_/datasets/occluded_dotav1.py',
    '../configs/_base_/schedules/schedule_1x.py',
    '../configs/_base_/default_runtime.py'
]

work_dir = './work_dirs/occluded_dota/srt_mask_oriented_rcnn_r101_fpn_250423'
...
log_level = 'INFO'
load_from = './work_dirs/dota/oriented_rcnn_r101_fpn_240503/latest.pth'
resume_from = None
work_dir = work_dir
workflow = [('train', 1)]
