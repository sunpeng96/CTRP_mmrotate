...
```shell
python demo/image_demo.py demo/demo.jpg oriented_rcnn_r50_fpn_1x_mask_dota_le90.py oriented_rcnn_r50_fpn_1x_dota_le90-6d2b2ce0.pth --out-file result.jpg
```
...
config_file = 'oriented_rcnn_r50_fpn_1x_mask_dota_le90.py'
